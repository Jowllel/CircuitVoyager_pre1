...
\label{sec:Review}
\begin{figure}[H]
  \label{fig:Review page 1}
	\centering
    \framebox{
	\includegraphics[width=14.5cm, page=1]{../../../1_Agreement_Review/2_Review_CircuitVoyager_Pre1_jschaller.pdf}}
	\caption{Review page 1}
\end{figure}
\newpage
\begin{figure}[H]
  \label{fig:Review page 2}
	\centering
    \framebox{
	\includegraphics[width=14.5cm, page=2]{../../../1_Agreement_Review/2_Review_CircuitVoyager_Pre1_jschaller.pdf}}
	\caption{Review page 2}
\end{figure}
\newpage
\begin{figure}[H]
  \label{fig:Review page 3}
	\centering
    \framebox{
	\includegraphics[width=14.5cm, page=3]{../../../1_Agreement_Review/2_Review_CircuitVoyager_Pre1_jschaller.pdf}}
	\caption{Review page 3}
\end{figure}
\newpage
\begin{figure}[H]
  \label{fig:Review page 4}
	\centering
    \framebox{
	\includegraphics[width=14.5cm, page=4]{../../../1_Agreement_Review/2_Review_CircuitVoyager_Pre1_jschaller.pdf}}
	\caption{Review page 4}
\end{figure}
\newpage
...
\lstset{language=C,caption={CV FW 1},label=DescriptiveLabel, style=mystyle}
\begin{codeblock}
	\lstinputlisting[firstline=1, lastline=38]{../../../6_Software/CV_FW/CM7/Core/Usercode/usermain_CM7.c}
\end{codeblock}

\newpage

\lstset{language=C,caption={CV FW 2},label=DescriptiveLabel, style=mystyle}
\begin{codeblock}
	\lstinputlisting[firstline=41, lastline=77]{../../../6_Software/CV_FW/CM7/Core/Usercode/usermain_CM7.c}
\end{codeblock}

\newpage

\lstset{language=C,caption={CV FW 3},label=DescriptiveLabel, style=mystyle}
\begin{codeblock}
	\lstinputlisting[firstline=78, lastline=108]{../../../6_Software/CV_FW/CM7/Core/Usercode/usermain_CM7.c}
\end{codeblock}

\newpage

\lstset{language=C,caption={CV FW 4},label=DescriptiveLabel, style=mystyle}
\begin{codeblock}
	\lstinputlisting[firstline=109]{../../../6_Software/CV_FW/CM7/Core/Usercode/usermain_CM7.c}
\end{codeblock}